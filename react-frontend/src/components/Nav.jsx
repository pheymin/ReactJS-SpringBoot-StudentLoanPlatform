...
export default function Nav() {
    ...
    useEffect(() => {
        if (localStorage.getItem('userID') !== null) {
            ...
            // Set the initial current value based on the first link
            if (updatedNavigation.length > 0) {
    ...
    function handleClick(e) {
        ...
        // Update the current property based on the clicked link
        const updatedNavigation = navigation.map(item => ({
            ...item,
            current: item.name === clickedLink,
        }));

        setCurrent(clickedLink);
        setNavigation(updatedNavigation);
    }
